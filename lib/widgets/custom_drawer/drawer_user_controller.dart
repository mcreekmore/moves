  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        //physics: const PageScrollPhysics(parent: ClampingScrollPhysics()), // original
        // physics: isMapScreen
        //     ? NeverScrollableScrollPhysics()
        //     : const PageScrollPhysics(parent: ClampingScrollPhysics()), // attempted at switching but this only builds once
